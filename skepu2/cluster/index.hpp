...
namespace skepu2
{
	...
	// Because both skepu2::Vector<T> and skepu2::Matrix<T> use the
	// same data type, skepu2::cluster::starpu_matrix_container<T>, as
	...
	// skepu2/impl/common.hpp. It needs to be either copied or be
...
#include <skepu2/cluster/impl/index.inl>
