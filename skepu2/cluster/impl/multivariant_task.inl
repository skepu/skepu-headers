...
#include <skepu2/cluster/multivariant_task.hpp>
#include <skepu2/cluster/container_cut.hpp>
#include <skepu2/cluster/handle_modes.hpp>
#include <skepu2/cluster/helpers.hpp>
#include <skepu2/cluster/task_schedule_wrapper.hpp>
#include <climits>
	...
	namespace cluster
	{
		                             ...
		                             Args & ...args)
		{
			...
			while (i.row < total_size.row)
			{
				...
				if(dir == skepu2::SweepMode::RowWise) {
					max_rows =
				...
				while (i.col < total_size.col)
				{
					...
					Index2D r_i {0, dir == skepu2::SweepMode::RowWise ? i.row : i.col, 0};
					auto r_cuts =
