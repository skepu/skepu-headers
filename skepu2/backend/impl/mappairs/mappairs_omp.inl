...
namespace skepu2
{
	namespace backend
	{
		...
		::OMP(size_t Hsize, size_t Vsize, pack_indices<VEI...>, pack_indices<HEI...>, pack_indices<AI...>, pack_indices<CI...>, Iterator res, CallArgs&&... args)
		{
			DEBUG_TEXT_LEVEL1("OpenMP MapPairs: size = " << size);
...
#pragma omp parallel for
			...
			for (size_t i = 0; i < Vsize; ++i)
			{
				for (size_t j = 0; j < Hsize; ++j)
				{
					...
					res(i, j) = F::forward(MapPairsFunc::OMP, (res + i).getIndex(), get<VEI, CallArgs...>(args...)(i)..., get<HEI, CallArgs...>(args...)(i)..., get<AI, CallArgs...>(args...).hostProxy()..., get<CI, CallArgs...>(args...)...);
				}
			}
		}
	}
