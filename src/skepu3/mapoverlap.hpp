...
namespace skepu
{
	...
	namespace impl
	{
		...
		private:
			...
			friend MapOverlap1D<Ret, Arg1, Args...> skepu::MapOverlapWrapper<Ret, Arg1, Args...>(MapFunc);
		};
		...
		private:
			...
			friend MapOverlap2D<Ret, Arg1, Args...> skepu::MapOverlapWrapper<Ret, Arg1, Args...>(MapFunc);
		};
