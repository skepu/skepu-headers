...
namespace skepu
{
	namespace backend
	{
		 ...
		 *
		 *  This class defines the Map skeleton, a calculation pattern where a user function is applied to each element of the cartesian product of input vectors.
		 *  Result is a Matrix.
		 */
